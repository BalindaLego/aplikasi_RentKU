...
import 'package:rentku/screen/home_page.dart';
import 'package:rentku/screen/register_screen.dart';
    ...
    return Scaffold(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            "Selamat datang, Mohon masukan kembali username dan password anda. Terimakasih",
          ...
          Card(
            color: Color.fromARGB(107, 82, 185, 229),
            elevation: 5,
            child: InkWell(
